...
### นำเข้าด้วยไฟล์ Excel (รับของเข้าล็อตใหม่)
1. กด **📄 ดาวน์โหลด Template** — ได้ไฟล์ .xlsx ที่มีหัวคอลัมน์: รหัสสี, กว้าง(ม.), สูง(ม.), จำนวน(ผืน), ประเภทผ้าม่าน, การต่อผ้า
2. กรอกข้อมูลในไฟล์ (แต่ละแถว = 1 รายการ)
3. กด **📤 อัพโหลด Excel** (ต้องปิดการเบิกก่อน) — ทุกแถวจะถูกเติมลงแท็บเป็น **แถวใหม่ต่อท้าย** (ไม่รวมกับของเดิม เหมาะกับการรับล็อตใหม่ที่แยกเฉด)
4. ตรวจสอบ/แก้ไขในตารางได้ แล้วกด **💾 บันทึกทั้งหมด**

### ค้นหาขนาดอัจฉริยะ (หน้าเบิกสต๊อก)
กรอกกว้าง+สูงที่ต้องการ ระบบจะหา:
- ขนาดที่**พอดี** (แสดง "✅ ขนาดพอดี")
- ขนาดที่**ใหญ่กว่าแต่ตัดแก้ได้** — ตัดออกได้ไม่เกิน 50 ซม. ต่อด้าน (ตัดได้ทั้งกว้างและสูงในผืนเดียว) แสดง "✂️ ตัดกว้าง X ซม. · ตัดสูง Y ซม."
- เรียงจากตัดน้อยสุด (พอดีก่อน)
